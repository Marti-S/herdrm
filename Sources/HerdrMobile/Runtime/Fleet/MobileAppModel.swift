...
final class MobileAppModel {
  ...
  let navigation = MobileNavigationState()

  var selectedDeviceID: UUID? {
    get { navigation.selectedDeviceID }
    set { navigation.selectedDeviceID = newValue }
  }
  var selectedSpaceRef: FleetSpaceRef? {
    get { navigation.selectedSpaceRef }
    set { navigation.selectedSpaceRef = newValue }
  }
  var selectedPaneRef: FleetPaneRef? {
    get { navigation.selectedPaneRef }
    set { navigation.selectedPaneRef = newValue }
  }
  var showAddConnection: Bool {
    get { navigation.showAddConnection }
    set { navigation.showAddConnection = newValue }
  }
  ...
  @ObservationIgnored private let conversationReaderCache = ConversationReaderCache()
  ...
  func conversationStore(
    ...
    conversationReaderCache.reader(for: ref, agent: agent, transport: transport)
  }
